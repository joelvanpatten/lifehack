    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        ...
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 text-xl text-[#f53003] dark:text-[#FF4433]">Notifish</h1>
                    <h2 class="mb-1 font-medium">A lightweight event logging and visibility system for internal operational awareness. </h2>
                    <hr class="mb-5">
                    <h2 class="mt-4 mb-1 font-thin text-xs">A Code Sample Demo App</h2>
                    <h2 class="mb-1 text-md text-[#706f6c] dark:text-[#A1A09A]">Created by Joel Van Patten</h2>
                    <hr class="mb-5">
                    <h2 class="mb-3 font-medium">Laravel 12 with Vue Starter Kit</h2>
                    <p class="m-1 inline-block bg-sidebar-accent text-stone-400 text-xs px-3 py-1 rounded-full">
                        Redis
                    </p>
                    <p class="m-1 inline-block bg-sidebar-accent text-stone-400 text-xs px-3 py-1 rounded-full">
                        Sail
